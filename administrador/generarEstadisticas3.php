...
// Función para calcular el total de un grupo
...
$datosGrupos = [];
//en este foreach iremos recorriendo los distintos grupos sacando sus medias y sus totales los cuales luego los pondremos en la tabla
...
//Creamos la tabla con sus estilos
echo '<style>
    table {
        width: 100%;
...
echo '</tr>';
$contador=0;
//Iremos añadiendo a la tabla los tr y td necesarios por cada  $datosGrupo
...
?>
            ...
            // Procesar los resultados de la consulta por familia
      ...
      <div class="row">
         ...
         <div class="col-6 d-grid gap-3 divGraficos">
            ...
            <?php
                ...
                // Escribimos los datos en un JSON
