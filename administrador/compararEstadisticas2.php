...
<main class="container-fluid mt-4 p-0">
    <div class="row">
        ...
        <?php
        //Función para ir creando las distintas consultas a la base de datos dependiendo de entre qué cosas queremos comparar
        function construirConsulta($conn)
        {
            $where = [];
        ...
        // Consulta para obtener la medica, el total y el modificador
        $result = $conn->query(construirConsulta($conn));
