...
<main class="container-fluid mt-4 p-0">
    <div class="row">
        ...
        function construirConsulta()
        {
            ...
            if (isset($_GET['selectGrado'])) {
                if(count($_GET['selectGrado'])==1){
                    ...
                    $where[] = "grado IN ('".implode("' , '",$_GET['selectGrado'])."')";
                }
            }
        ...
        // Consulta para obtener la frecuencia de cada número en la columna 'p37'
        ...
        <canvas id="bar-chart"></canvas>
            ...
            <div class="col-2 mx-5">
                ...
                <div class="media">
                    ...
                    //Calculamos y mostramos la media de los reusltados
